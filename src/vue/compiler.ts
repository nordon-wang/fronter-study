...
class Compiler {
  ...
  // 判断是不是vue的指令, 以 v- 开头
  public isDirective(attrName) {
    return attrName.startsWith("v-");
  }

  // 判断是否是 事件指令
  public isEventDirective(type) {
